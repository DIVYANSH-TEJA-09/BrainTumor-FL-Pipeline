"""
3D Progression Prediction Visualization - Enhanced Multi-Panel with Brain Overlay
==================================================================================

Streamlit page showing:
  - 3 separate 3D panels: Actual tumor, Logistic baseline prediction, LSTM hybrid prediction
  - Brain overlay on all panels for anatomical context
  - Volume trajectory plot over time
  - Metrics comparison
  
All 3D meshes are interactive and overlaid on brain surface.
...
st.title("3D Tumor Growth Prediction with Brain Overlay")
st.markdown("**Actual** (blue) vs **Baseline** (red) vs **LSTM Hybrid** (green) with anatomical brain context")
